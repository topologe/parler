...
var LDAvis = function(to_select, data_or_file_name, color1, color2) {
    ...
    var K, // number of topics
        ...
        global_topics = {
        1:"Elections", 2:"Immigration Detention", 3:"Vaccines/School", 4:"Miscellaneous", 5:"Antifa & Police", 6:"Fact vs Fiction", 7:"Insurrection", 8:"Left Wing Politics"
        },
        lambda = {
            old: 1,
            current: 1
...
//            .attr("fill", "gray");
        ...
        var defaultLabelSmall = "2% of posts";
        var defaultLabelMedium = "5% of posts";
        var defaultLabelLarge = "10% of posts";
...
//            .text("EDIT SUCCESSFUL!!");
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            var xx = d3.select("#" + lambdaZeroID)
                ...
                .text("Uniqueness to Topic Metric:");
            ...
            lambdaLabel.innerHTML = "<span id='" + lambdaID + "-value'>" + vis_state.lambda + "</span>";
        ...
        function topic_on(circle) {
            ...
            d3.select("#" + barFreqsID)
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("Top-" + R + " Most Relevant Terms for Topic " + topics + " (" + Freq + "% of words)");
